        ...
        if (Image != NULL) {
            ...
            if (NumChannels < 2 || NumChannels > 4) {
                ...
                if (Mask == RGBMask || Mask == RGBAMask) {
                    uint64_t Chroma1Index                         = ImageContainer_GetChannelsIndex(Image, ImageMask_Chroma1);
                    uint64_t LumaIndex                            = ImageContainer_GetChannelsIndex(Image, ImageMask_Luma);
                    uint64_t Chroma2Index                         = ImageContainer_GetChannelsIndex(Image, ImageMask_Chroma2);
                    ...
                    ImageContainer_SetChannelMap(Image, LumaIndex, ImageMask_Red);
                    ImageContainer_SetChannelMap(Image, Chroma1Index, ImageMask_Green);
                    ImageContainer_SetChannelMap(Image, Chroma2Index, ImageMask_Blue);
                } else {
