...
extern "C" {
    ...
    void ForwardTransform_RCT(ImageContainer *Image) {
        if (Image != NULL) {
            Image_ChannelMask Mask                                = ImageContainer_GetChannelMask(Image);
            ...
            if (NumChannels < 2 || NumChannels > 4) {
                ...
                if (Mask == RGBMask || Mask == RGBAMask) {
                    uint64_t RedIndex                             = ImageContainer_GetChannelsIndex(Image, ImageMask_Red);
                    uint64_t GreenIndex                           = ImageContainer_GetChannelsIndex(Image, ImageMask_Green);
                    uint64_t BlueIndex                            = ImageContainer_GetChannelsIndex(Image, ImageMask_Blue);
                    ...
                    ImageContainer_SetChannelMap(Image, RedIndex, ImageMask_Chroma1);
                    ImageContainer_SetChannelMap(Image, GreenIndex, ImageMask_Luma);
                    ImageContainer_SetChannelMap(Image, BlueIndex, ImageMask_Chroma2);
                } else {
    ...
    static OVIACodecRegistry Register_ForwardTransformYCoCgR = {
        .Function_ForwardTransform[ColorTransform_YCoCgR - 1]      = &RegisterTransform_ForwardRCT,
    };
